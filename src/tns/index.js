...
export const tns = function (options) {
  ...
  var CALC = tnsStorage["tC"]
    ...
    TRANSITION_DURATION = tnsStorage["tTDu"]
      ...
      : setLocalStorage(
          tnsStorage,
          "tTDu",
          whichProperty("TRANSITION_DURATION"),
          localStorageAccess
        ),
    TRANSITION_DELAY = tnsStorage["tTDe"]
      ...
      : setLocalStorage(
          tnsStorage,
          "tTDe",
          whichProperty("TRANSITION_DELAY"),
          localStorageAccess
        ),
    ANIMATION_DURATION = tnsStorage["tADu"]
      ...
      : setLocalStorage(
          tnsStorage,
          "tADu",
          whichProperty("ANIMATION_DURATION"),
          localStorageAccess
        ),
    ...
    TRANSITIONEND = tnsStorage["tTE"]
      ...
      : setLocalStorage(
          tnsStorage,
          "tTE",
          getEndProperty(TRANSITION_DURATION, "Transition"),
          localStorageAccess
        ),
    ANIMATIONEND = tnsStorage["tAE"]
      ...
      : setLocalStorage(
          tnsStorage,
          "tAE",
          getEndProperty(ANIMATION_DURATION, "Animation"),
          localStorageAccess
        );
  ...
  function getTRANSITION_DURATIONStyle(speed) {
    return (
      getCSSPrefix(TRANSITION_DURATION, 18) +
      "transition-duration:" +
      speed / 1000 +
      "s;"
    );
  ...
  function getANIMATION_DURATIONStyle(speed) {
    return (
      getCSSPrefix(ANIMATION_DURATION, 17) +
      "animation-duration:" +
      speed / 1000 +
      "s;"
    );
  ...
  function initStructure() {
    ...
    newContainerClasses +=
      PERCENTAGE_LAYOUT || autoWidth ? " tns-subpixel" : " tns-no-subpixel";
      ...
      if (TRANSITION_DURATION) {
        var str =
          middleWrapper && options.autoHeight
            ? getTRANSITION_DURATIONStyle(options.speed)
            : "";
    ...
    if (responsive && CSS_MQ) {
      for (var bp in responsive) {
        ...
        if (
          ...
          middleWrapperStr =
            "#" + slideId + "-mw{" + getTRANSITION_DURATIONStyle(speedBP) + "}";
        }
  ...
  function initTools() {
    ...
    if (hasNav) {
      ...
      // add transition
      if (TRANSITION_DURATION) {
        var prefix = TRANSITION_DURATION.substring(
            0,
            TRANSITION_DURATION.length - 18
          ).toLowerCase(),
  ...
  function animateSlide(number, classOut, classIn, isOut) {
    ...
    for (var i = number; i < l; i++) {
      ...
      if (animateDelay && TRANSITION_DELAY) {
        item.style[TRANSITION_DELAY] = item.style[ANIMATION_DELAY] =
  ...
  function onNavClick(e) {
    ...
    if (hasAttr(target, "data-nav")) {
      var navIndex = (navClicked = Number(getAttr(target, "data-nav"))),
        targetIndexBase =
          fixedWidth || autoWidth
            ? (navIndex * slideCount) / pages.value
            : navIndex * items,
